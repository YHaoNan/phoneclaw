...
function executeScriptOnServer(script) {
...
function parseScriptServerResponse(response) {
...
async function main() {
    ...
    server.tool("executeScript", `Execute a Lua script on the connected PhoneClaw device via ScriptServer.
